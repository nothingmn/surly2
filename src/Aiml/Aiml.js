 ...
 */
Aiml.prototype.parseAiml = function (aiml) {
  // @todo handle topics
 ...
 */
Aiml.prototype.hasData = function () {
 ...
 */
Aiml.prototype.findTemplate = function (sentence) {
  if (!this.hasData()) {
 ...
 * @return {Undefined}
 */
Aiml.prototype.loadDir = function (dir, callback) {
 ...
 * @return {Undefined}
 */
Aiml.prototype.loadFile = function(file, callback) {
 ...
 * @param  {String} msg
  */
Aiml.prototype.log = function (msg) {
 ...
 * @return {Undefined}
 */
Aiml.prototype.debug = function (msg) {
 ...
 */
Aiml.prototype.normaliseSentence = function (sentence) {
